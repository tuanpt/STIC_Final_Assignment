...
spacex_df = pd.read_csv("/Users/tuanpt/Documents/projects/python/Book_ML/STIC/PDS/My-IBM-Data-Science-Professional-Certificate/4. Interactive Visual Analytics/spacex_launch_dash.csv")
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All Sites':
        fig = fx.pie(spacex_df, values='class', names='Launch Site', title='Total Success Launches by Site')
        return fig
    else:
...
def get_scatter_chart(entered_site, payload_slider):
    ...
    if entered_site == 'All Sites':
        fig = px.scatter(
            dropdown_scatter, x='Payload Mass (kg)', y='class', hover_data=['Booster Version'],
